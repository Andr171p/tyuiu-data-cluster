...
df = pd.read_csv(r'C:\Users\andre\TyuiuClusterModel\data\interim\tyuiu-students-2019-2024.csv')
print(df.columns)
...
comp_columns = ['Графическая композиция', 'Композиция', 'Композиция архитектура', 'Композиция дизайн']
